...
// Intelligence Panel Component (defined outside of MeetingLiveView)
function IntelligencePanel({
  isTranscriptOpen,
  setIsTranscriptOpen,
  detectedTasks,
  toggleTaskConfirmation,
}: {
  isTranscriptOpen: boolean
  setIsTranscriptOpen: (open: boolean) => void
  detectedTasks: DetectedTask[]
  toggleTaskConfirmation: (taskId: string) => void
}) {
                ...
                <Sheet open={isIntelligenceOpen} onOpenChange={setIsIntelligenceOpen}>
                  ...
                  <SheetContent side="right" className="w-full sm:w-[400px] p-0 flex flex-col">
                    ...
                    <IntelligencePanel
                      ...
                      toggleTaskConfirmation={toggleTaskConfirmation}
                    />
                  </SheetContent>
                </Sheet>
              </>
