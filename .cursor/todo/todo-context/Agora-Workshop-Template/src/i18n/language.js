...
function __getLanguageData(language, success, fail) {
  let url = "";
  if (LANGUAGE_CACHE_DATA[language] && LANGUAGE_CACHE_DATA[language].sampleCode) {
...
function __insertLanguageSwitch() {
  const languageSwitchHtml = `<div class="btn-group language-list">
            ...
            <ul class="dropdown-menu gap-1 p-2 rounded-3 mx-0 border-0 shadow">
                ...
                <li class="dropdown-item rounded-2" id="language-zh">Simplified Chinese</li>
            </ul>
        </div>`;
  ...
  if (language == "en") {
    ...
    $("#language-text").text("Simplified Chinese");
  }
